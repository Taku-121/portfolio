<?php get_header() ?>
    <section class="Title">
        <h2 class="Title__name">
            <svg version="1.1" id="logo" class="Title__logoSvg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.89 595.28" style="enable-background:new 0 0 841.89 595.28;" xml:space="preserve" width="841.8900146484375" height="595.280029296875">
                <style type="text/css">
    ...
    <main class="main">
        <section class="Profile wrapper">
            <h2 class="Profile__title indices">Profile</h2>
            <div class="Profile__flex">
                <img class="Profile__img fadeIn" src="<?php echo esc_url(get_theme_file_uri('/img/takuma1.jpg')); ?>" alt="平川巧真 人物写真">
                <div class="TextBox anim-box">
                    <h3 class="TextBox__title">平川巧真</h3>
                    <ul class="TextBox__list">
                        <li class="TextBox__listItem">年齢:22歳</li>
                        <li class="TextBox__listItem">生年月日:2003年2月2日</li>
                        <li class="TextBox__listItem --indention">出身：宮崎県</li>
                        <li class="TextBox__listItem">趣味:</li>
                        <li class="TextBox__listItem">読書（ジャンル問わず）</li>
                        <li class="TextBox__listItem">Youtube鑑賞（<a href="https://www.youtube.com/channel/UC0N2mghwqb4UzPGqE8yIX-Q" class="TextBox__listLink">SKJvillage</a>さんが好きです）</li>
                        <li class="TextBox__listItem">ゲーム（仲間と協力するゲームが好き）</li>
                        <li class="TextBox__listItem">音楽鑑賞（最近は<a href="https://www.youtube.com/@ProjectMili" class="TextBox__listLink">Mili</a>さんの曲にハマってます）</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div class="parallax">
            <section class="StrongPoints wrapper fadeIn">
                <h2 class="StrongPoints__title indices">私の強み</h2>
                <p class="StrongPoints__text">私の強みは新しいことに挑戦する意欲です。<br>
                    これまでに、接客業から文書処理、パンフレットや看板の制作、名刺デザインからYouTuberの動画編集代行まで、幅広いアルバイトに挑戦してきました。
                    デザイン系の専門学校を卒業後、自身のスキルをさらに高めるため、京都芸術大学通信学部に編入しました。専門学校では学べなかった理論的な芸術を学ぶことで、大きな成長を実感しています。
                    現在、2026年4月の卒業を予定していますが、卒業制作を含む残りの授業はわずか4回のみです。この通信制の特性を活かし、大学の学業と並行して先に就職することを目指しています。
                    その一環として職業訓練校にも通い、新しいスキルを習得中です。</p>
                <p class="StrongPoints__text">
                    新しいことへの好奇心を大切にし、挑戦を通じて自信を養ってきました。この精神を社会人としても発揮し、どんな仕事にも粘り強く取り組む覚悟です。
                    これまでの経験は、私を成長させてくれました。今後も積極的に新しい挑戦を続け、自分のスキルをさらに磨き続けていきます。
                    どのプロジェクトにも情熱を持って取り組み、創造的な課題に対して真摯に向き合っていく所存です。</p>
            </section>
        </div>
            ...
            <?php
                    ...
                    if ($query->have_posts()) {
                        while ($query->have_posts()) {
                            ...
                            $posts_list[] = array(
                                ...
                                'thumbnail' => has_post_thumbnail() ? get_the_post_thumbnail(null, 'medium', array('class' => 'Work__listImg')) : '<img src="' . esc_url(get_theme_file_uri('/img/ph.png')) . '" alt="" class="Work__listImg">'
                            );
                        }
                    }
                ...
                if (!empty($posts_list)) {
                    foreach ($posts_list as $post) {
                        ...
                        echo $post['thumbnail']; 
                        echo '<h3 class="Work__listTitle">' . $post['title'] . '</h3>';
                        echo '</a>';
                        echo '</li>';
                    }
                } else {
